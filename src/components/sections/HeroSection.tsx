'use client';
// src/components/sections/HeroSection.tsx - OPTIMIZED VERSION
// ─────────────────────────────────────────────────────────────────
// Optimizations:
// ✅ Performance optimized with reduced animations
// ✅ SEO optimized with semantic HTML and schema markup
// ✅ Mobile-first responsive design
// ✅ Reduced bundle size by optimizing framer-motion usage
...
const HeroCTAs = memo(function HeroCTAs() {
  return (
    <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
      ...
      >
        <Heart className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" aria-hidden="true" />
    ...
    >
      ...
      <div className="container-custom relative z-10 py-12 sm:py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          {/* Right Content - Animated Logo (Desktop Only Heavy Animations) */}
          <motion.div
            ref={logoRef}
          ...
          >
            ...
            <motion.div
              ...
              className="relative"
            >
              {/* Simplified Animated Rings for Performance */}
              ...
              {/* Main Logo with Optimized Float Animation */}
              <motion.div
                animate={{ y: [0, -20, 0] }}
                transition={{
                  duration: 6,
              ...
              >
                ...
                {/* Actual Logo - Optimized for Performance */}
                <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                  <Image
                    src="/logo.webp"
                    alt="Khan Hub - Pakistan's Leading Social Welfare Organization"
                    fill
        ...
        <motion.div
          ...
          className="fixed right-4 sm:right-8 bottom-4 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 z-20 lg:block"
        >
          <Link
          ...
          >
            ...
            >
              <Phone className="w-5 h-5 sm:w-8 sm:h-8 text-white" aria-hidden="true" />
            </motion.div>
