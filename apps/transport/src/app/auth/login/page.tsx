...
import { Mail, Lock, ArrowRight, ShieldCheck, Loader2, Car, Eye, EyeOff, CheckCircle2, Star } from 'lucide-react';
        ...
        <div className="flex-grow flex items-center justify-center bg-white py-20 px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-md w-full space-y-10 relative z-10">
                <div className="text-center">
                    <Link href="/" className="inline-block mb-10 transition-transform hover:scale-105 active:scale-95 group">
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <span className="text-4xl font-black tracking-tighter text-[#2F5D50]">KHAN<span className="text-gray-900 font-bold">HUB</span></span>
                        </div>
                    </Link>
                    <h2 className="text-5xl font-black text-gray-900 tracking-tight mb-2">Welcome Back</h2>
                ...
                <div className="glass-panel p-12 rounded-[4rem] premium-shadow border-white/50 relative overflow-hidden">
                    ...
                    <div className="space-y-4 mb-10">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase tracking-[0.4em] font-black">
                                <span className="px-6 bg-white/40 backdrop-blur-md rounded-full text-gray-400">Secure Access</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        {error && (
                            <div className="bg-red-50 text-red-600 p-5 rounded-[2rem] text-sm font-black border border-red-100 flex items-center gap-3 animate-shake">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between mb-1 ml-2">
                                    <label className="text-[10px] font-black uppercase tracking-widest text-[#2F5D50]/60">Secret Password</label>
                                    <Link href="/auth/forgot-password" px-4 className="text-[10px] font-black text-[#3FA58E] hover:text-[#2F5D50] transition-colors">
                                        RECOVER
                                    </Link>
                                </div>
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-100 text-center">
                        <p className="text-sm text-gray-400 font-bold">
                            New Partner?{' '}
                            <Link href="/auth/register" className="text-[#3FA58E] hover:text-[#2F5D50] underline underline-offset-8 decoration-[#3FA58E]/30 transition-all font-black">
                                Join Network
                            </Link>
                        </p>
                    </div>
...
function FormInput({ label, name, type = 'text', placeholder, icon, value, onChange }: any) {
    return (
        <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-[#2F5D50]/60 ml-2">{label}</label>
            <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none group-focus-within:text-[#2F5D50]">
