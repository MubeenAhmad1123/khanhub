// File: apps/transport/src/app/auth/register/RegisterPageClient.tsx
'use client';
      ...
      <div className="w-full max-w-lg space-y-8 relative z-10">
        ...
        <div className="glass-panel p-10 md:p-11 rounded-[3rem] premium-shadow border-white/50 relative overflow-hidden">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {error && (
              <div className="bg-red-50 text-red-600 p-4 rounded-[2rem] text-sm font-black border border-red-100">
                <div className="flex items-start gap-3">
                  <div className="h-2 w-2 rounded-full bg-red-600 animate-ping mt-2 flex-shrink-0" />
