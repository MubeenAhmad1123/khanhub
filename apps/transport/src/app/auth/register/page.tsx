...
// DESCRIPTION: Registration page for Khanhub Transport
// Path: C:\Users\abc\Documents\Khanhub\khanhub\apps\transport\src\app\auth\register
'use client'
      ...
      <div className="container">
        <div className="auth-container">
          <div className="auth-header">
            ...
            <p>Join Khanhub Transport network</p>
          </div>
