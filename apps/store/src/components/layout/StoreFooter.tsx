                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            />
                            <div>
                                <h3 className="text-white font-bold text-lg">Khanhub Store</h3>
                    ...
                    <div>
                        ...
                        <div className="mt-6">
                            ...
                            <ul className="space-y-2">
                                {policies.map((policy) => (
                                    <li key={policy.href}>
                                        <Link href={policy.href} className="text-sm hover:text-white transition-colors">
                                            {policy.name}
                                        </Link>
                                    </li>
                                ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            ...
                            <li className="flex items-center">
                                ...
                                <a href="mailto:store@khanhub.com.pk" className="hover:text-white">store@khanhub.com.pk</a>
                            </li>
                            <li className="flex items-start">
                ...
                <div className="mt-8 pt-8 border-t border-gray-800">
                    <div className="text-center">
                        ...
                        <div className="flex justify-center items-center space-x-6 flex-wrap gap-4">
                            ...
                            <div className="bg-white px-4 py-2 rounded">
                                <span className="text-blue-600 font-bold">🏦 Bank Transfer</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-gray-950 py-4">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                        <p>© {new Date().getFullYear()} Khanhub Store. All rights reserved.</p>
