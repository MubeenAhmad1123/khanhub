...
const FloatingDonateButton: React.FC = () => {
    return (
        <div className="fixed bottom-24 right-4 z-[9999] pointer-events-none lg:bottom-8 lg:right-6 scale-[0.96] lg:scale-100">
            <motion.div
            ...
            >
                <Link
                    href="/donate"
                    className="group flex items-center justify-center gap-3 bg-gradient-to-r from-red-500 via-pink-600 to-red-500 bg-[length:200%_auto] hover:bg-[100%_center] transition-all duration-500 text-white w-36 lg:w-auto px-6 py-4 rounded-full shadow-[0_5px_15px_rgba(239,68,68,0.4)] hover:shadow-[0_8px_25px_rgba(239,68,68,0.6)] border-2 border-white/20"
                >
