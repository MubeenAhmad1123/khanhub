...
export default function UserMenu() {
    ...
    if (!user) {
        return (
            <Link
                href="/auth/signin"
                className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:scale-105 transition-all duration-300 inline-flex items-center gap-2 group whitespace-nowrap"
            >
