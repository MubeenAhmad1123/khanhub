// src/components/hospital/patient-profile/DailySheetTab.tsx
import React, { useState, useEffect, useCallback, useMemo } from 'react';
import { DailyActivityRecord, DAILY_ACTIVITIES, ActivityStatus } from '@/types/hospital';
import { getDailyActivities, saveDailyActivity } from '@/lib/hospital/patients';
