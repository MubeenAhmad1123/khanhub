// src/components/hospital/patient-profile/AdmissionTab.tsx
...
export default function AdmissionTab({ 
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      await updateDoc(doc(db, 'hospital_patients', patient.id), {
        ...form
      });
      onUpdate(form);
      setIsEditing(false);
    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="space-y-6">
        ...
        <SectionCard title="3. Addiction & Treatment" icon={Shield}>
          ...
          <Field label="Previous Hospital Center" value={form.previousHospital} fieldKey="previousHospital" />
        </SectionCard>
