...
const navItems: NavItem[] = [
  { label: 'Family View', href: '/departments/job-center/dashboard/family', roles: ['family'] },
  ...
  { label: 'Patients', href: '/departments/job-center/dashboard/admin/patients', roles: ['admin', 'superadmin'] },
...
export default function JobCenterSidebar({ role, patientId }: { role: JobCenterRole, patientId?: string }) {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-100 flex-shrink-0 flex flex-col min-h-screen">
      <div className="p-6 border-b border-gray-50 flex items-center gap-3">
        ...
        <span className="font-bold text-[#1D9E75] text-lg">JobCenter Portal</span>
      </div>
