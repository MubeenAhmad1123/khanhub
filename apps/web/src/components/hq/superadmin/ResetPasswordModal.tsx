...
import { X, Key, Loader2, AlertCircle, Shield } from 'lucide-react';
...
export function ResetPasswordModal({ uid, portal, onClose }: ResetPasswordModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-md overflow-hidden rounded-[2rem] bg-white shadow-2xl dark:bg-[#0A0A0A] dark:border dark:border-white/10 animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-8">
          {success ? (
            <div className="py-8 text-center space-y-4">
              ...
              <div>
                <p className="text-lg font-black text-gray-900 dark:text-white">Password Updated!</p>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">New Secure Password</label>
