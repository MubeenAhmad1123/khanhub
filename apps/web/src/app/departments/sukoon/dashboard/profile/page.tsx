          ...
          {session?.role === 'family' ? (
             <div className={`p-8 md:p-10 rounded-[3.5rem] ${glassStyle}`}>
                <div className="flex items-center gap-3 mb-8">
                  <div className="p-2 bg-[#FCFBF8] rounded-xl text-teal-600"><Heart size={20} /></div>
                  ...
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                      ...
                      <input
                        ...
                        className="bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm font-bold text-gray-700 outline-none focus:ring-2 focus:ring-teal-500/20 w-full sm:w-auto"
                      />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                       ...
                       <div className={`p-8 rounded-[3rem] ${neumorphicOutset} bg-[#FCFBF8] text-center`}>
                          <TrendingUp className="mx-auto text-teal-600 mb-2" size={32} />
                      ...
                      {growthHistory.filter(r => (r.month || (r.date ? r.date.substring(0, 7) : '')) === selectedMonth).length > 0 ? (
                        growthHistory.filter(r => (r.month || (r.date ? r.date.substring(0, 7) : '')) === selectedMonth).map(record => (
                          <div key={record.id} className={`p-5 rounded-3xl ${neumorphicOutset} bg-[#FCFBF8] flex items-center justify-between`}>
                            <div className="flex items-center gap-4">
                              <div className="p-3 rounded-2xl bg-teal-50 text-teal-600"><Award size={20} /></div>
                              <div>
                            ...
                            <div className="px-3 py-1 rounded-xl bg-white border border-slate-100 text-[10px] font-black text-teal-600">+{record.points} PTS</div>
                          </div>
                        ))
                      ) : (
                  ...
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                      ...
                      <div 
                        ...
                        className={`p-8 rounded-[3rem] ${neumorphicOutset} bg-teal-600 text-white relative overflow-hidden flex flex-col justify-between cursor-pointer hover:scale-[1.02] transition-all`}
                      >
                         ...
                         <p className="text-xs mt-4 font-medium opacity-70 border-t border-teal-500 pt-2">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200 text-gray-900">
          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div>
                <h3 className="text-sm font-black uppercase tracking-widest text-purple-600">Salary Breakdown</h3>
            ...
            <div className="p-8 overflow-y-auto space-y-6 flex-1 text-xs">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-purple-50/30 rounded-2xl border border-purple-100/50">
                  <p className="text-[9px] font-black text-purple-600 uppercase tracking-widest mb-1">Monthly Base Salary</p>
                  <p className="text-lg font-black text-gray-900">₨{Number(profile?.monthlySalary || profile?.salary || 0).toLocaleString()}</p>
                </div>
                <div className="p-4 bg-purple-50/30 rounded-2xl border border-purple-100/50">
                  <p className="text-[9px] font-black text-purple-600 uppercase tracking-widest mb-1">Net Till Date Earned</p>
