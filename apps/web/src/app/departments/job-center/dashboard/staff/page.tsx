      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white/5 rounded-2xl border border-white/10 p-4">
          ...
          <button
            ...
            className="w-full py-3 mt-3 rounded-2xl bg-orange-500 text-white text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-orange-500/20"
          >
            {submitted ? (
