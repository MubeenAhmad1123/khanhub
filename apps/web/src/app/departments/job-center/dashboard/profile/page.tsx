          ...
          <div className={`p-8 rounded-[3rem] ${glassStyle} flex flex-col items-center relative overflow-hidden`}>
            ...
            <div className="relative group">
              ...
              <button 
                ...
                className="absolute -bottom-2 -right-2 p-3 rounded-2xl bg-orange-600 text-white shadow-xl hover:scale-110 transition-all active:scale-95"
              >
                <Camera size={18} />
              </button>
                ...
                {activeTab === 'finance' && (
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                      <div className={`p-8 rounded-[3rem] ${neumorphicOutset} bg-orange-600 text-white relative overflow-hidden`}>
