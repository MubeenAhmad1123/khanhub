...
export default function SocialMediaDashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="min-h-screen bg-[#F0FBFF] flex items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-cyan-600 text-xs font-black uppercase tracking-[0.3em] animate-pulse">Broadcasting Node...</p>
        </div>
      </div>
    );
  }
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-[#FCFBF8]/50 backdrop-blur-xl border-r border-gray-200/50">
      {/* Header */}
      <div className="p-8">
        ...
        <div className="flex items-center gap-4 mb-10">
          <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-white shadow-2xl -rotate-3 transition-transform hover:rotate-0 duration-500 bg-gradient-to-br from-cyan-400 to-blue-600`}>
          ...
          <div className="flex p-1.5 bg-gray-100/50 rounded-2xl mb-8">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-[10px] font-black transition-all ${
                viewMode === 'dept' ? 'bg-white text-cyan-600 shadow-sm' : 'text-gray-400 hover:text-gray-600'
              }`}
            >
              DEPT
            </button>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-4 px-5 py-4 rounded-[1.5rem] text-sm transition-all relative group overflow-hidden ${
                  isActive 
                    ? 'bg-gradient-to-r from-cyan-500/10 to-transparent text-cyan-600' 
  ...
  return (
    <div className="min-h-screen flex bg-[#FCFBF8] text-black font-sans">
      {/* Sidebar Desktop */}
      ...
      <div className="flex-1 lg:ml-72 flex flex-col min-h-screen relative">
        ...
        {/* Top Header */}
        <header className="sticky top-0 z-20 bg-[#FCFBF8]/80 lg:bg-[#FCFBF8]/80 backdrop-blur-xl border-b border-gray-100 px-6 lg:px-12 py-4 lg:py-6 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div className="relative group hidden md:block">
              ...
              <input 
                ...
                className="bg-gray-100/50 border border-transparent focus:border-cyan-500/30 rounded-2xl pl-12 pr-6 py-2.5 text-xs font-medium w-80 outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 lg:gap-8">
             ...
             <div className="flex items-center gap-4">
                <div className="hidden sm:flex flex-col items-end">
                   <p className="text-xs font-black uppercase tracking-tight text-gray-950">{user?.displayName}</p>
