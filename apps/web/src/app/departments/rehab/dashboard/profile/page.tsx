              ...
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 space-y-2">
                ...
                <div className="space-y-1 font-mono text-gray-600">
                  <div className="flex justify-between">
                    ...
                    <span>₨{Number(profile?.monthlySalary || 0).toLocaleString()} / 30 = ₨{Math.round(salaryDetails.dailyWage).toLocaleString()} / Day</span>
                  </div>
                  {salaryDetails.isFinalized ? (
                    <>
                      <div className="flex justify-between text-emerald-600">
                        <span>Base Monthly Salary:</span>
                        <span>+ ₨{Number(profile?.monthlySalary || 0).toLocaleString()}</span>
                      </div>
