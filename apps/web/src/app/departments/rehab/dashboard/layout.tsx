  ...
  return (
    <div className={`min-h-screen flex ${darkMode ? 'bg-gray-950' : 'bg-gray-50'}`}>
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        {/* Mobile top bar */}
        <header className={`lg:hidden sticky top-0 z-50 backdrop-blur border-b px-4 py-3 flex items-center justify-between transition-colors duration-300 ${
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`font-black text-sm ${darkMode ? 'text-gray-100' : 'text-gray-900'}`}>Rehab Portal</span>
          </div>
