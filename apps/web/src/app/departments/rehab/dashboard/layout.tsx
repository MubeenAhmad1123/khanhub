...
export default function RehabDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className={`fixed left-0 top-0 h-screen w-72 bg-white z-50 lg:hidden transform transition-transform duration-300 ease-out shadow-2xl ${
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        ...
        {/* Desktop top bar */}
        <header className="hidden lg:flex sticky top-0 z-20 bg-white/80 backdrop-blur border-b border-gray-100 px-8 py-4 items-center justify-between">
