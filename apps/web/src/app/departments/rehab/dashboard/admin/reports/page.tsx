...
function calculatePatientOverallRemaining(
  ...
  const calculatedRemaining = (totalStayPackage + finalMedicineCharges) - overallReceived - totalDiscount + manualAdj;
    ...
    try {
      ...
      const patientFeesBreakdown = patients.map(patient => {
        ...
        return {
          ...
          paidInPeriod,
          amountPaidThisMonth,
          overallRemaining: calculatePatientOverallRemaining(patient, allFees, allTxnsForDues)
        };
      });
