  ...
  if (loading && !data) return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="text-center space-y-3">
        ...
        <p className="text-sm font-bold text-gray-600">Loading SPIMS Payroll...</p>
      </div>
    </div>
  );
                ...
                <div className="overflow-x-auto rounded-xl border border-gray-200">
                  <table className="w-full text-sm border-collapse min-w-[950px]">
                    <thead className="bg-teal-50">
                      <tr>
                        <th className="px-3.5 py-3 text-left font-bold text-teal-800 border-b border-gray-200">#</th>
                        ...
                        <th className="px-3.5 py-3 text-right font-bold text-teal-800 border-b border-gray-200">Total Ded.</th>
                        <th className="px-3.5 py-3 text-right font-bold text-teal-800 border-b border-gray-200 bg-teal-100/70">Net Salary To Pay</th>
                        <th className="px-2.5 py-3 text-center font-bold text-teal-800 border-b border-gray-200 no-print">Breakdown</th>
                      </tr>
                    </thead>
                    <tbody>
                      {data.salaryRows.map((r: any, i: number) => (
                        ...
                        >
                          ...
                          <td className="px-3.5 py-3.5 font-bold text-gray-900 group-hover:text-teal-700 transition-colors">{r.name}</td>
                          ...
                          <td className="px-3.5 py-3.5 text-right font-black text-teal-900 bg-teal-50 group-hover:bg-teal-100/80 transition-colors">
                      ...
                      <tr className="bg-teal-50 font-black text-xs">
                        <td colSpan={3} className="px-3.5 py-3.5 text-teal-800 uppercase tracking-wider">TOTAL</td>
                        <td className="px-3.5 py-3.5 text-right text-teal-800">{formatPKR(data.totalGross)}</td>
                        <td />
                        <td colSpan={2} />
                        ...
                        <td className="px-3.5 py-3.5 text-right text-teal-950 font-black text-sm bg-teal-100/90">{formatPKR(data.totalNet)}</td>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full border border-gray-100 overflow-hidden my-8 transform transition-all">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5">
                ...
                <div className="bg-teal-50 border border-teal-200 p-3 rounded-2xl text-center col-span-2 sm:col-span-1">
                  <div className="text-[10px] font-bold text-teal-700 uppercase tracking-wider mb-0.5">Net To Pay</div>
                  <div className="text-xs font-black text-teal-900">{formatPKR(selectedStaffModal.netPayable)}</div>
                  <div className="text-[9px] text-teal-600 font-bold mt-0.5">Final Payout</div>
                </div>
              </div>
              ...
              <div className="bg-teal-900 text-white rounded-2xl p-4 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-teal-300">Base Salary - Total Deductions (Absents + Fines + Advances)</div>
                </div>
