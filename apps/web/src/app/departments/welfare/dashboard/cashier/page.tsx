// src/app/departments/welfare/dashboard/cashier/page.tsx
'use client';
    ...
    <div className="min-h-[70vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-8 text-center animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          ...
          <span className="font-bold text-teal-600"> Khan Hub Headquarter (HQ)</span> portal for centralized financial management.
        </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-[10px] text-gray-400 font-medium uppercase tracking-widest">
            You will no longer be able to manage transactions from the Welfare portal.
          </p>
        </div>
      </div>
    </div>
