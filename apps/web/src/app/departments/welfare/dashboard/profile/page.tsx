        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
             <div className={`px-6 py-3 rounded-2xl ${glassStyle} flex items-center gap-3`}>
                ...
                <div><p className="text-[10px] font-black uppercase text-slate-400">Total Points</p><p className="text-lg font-black text-slate-900">{growthPoints?.totalPoints || 0}</p></div>
             </div>
          </div>
        </div>
      </div>
