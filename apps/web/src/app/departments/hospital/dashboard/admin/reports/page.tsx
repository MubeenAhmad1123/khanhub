        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
              <FileBarChart className="w-6 h-6 text-emerald-600" /> Hospital Reports
            </h1>
            <p className="text-sm text-gray-500 mt-1">Generate approved hospital transaction reports for any day, week, or month</p>
          </div>
          {generated && (
        ...
        {generated && reportData && (
          <div id="hospital-report-print" ref={printRef} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-10 space-y-8">
            ...
            <div className="text-center border-b border-gray-200 pb-6">
              <h2 className="text-2xl font-black text-gray-900">Khan Hub Hospital</h2>
                    ...
                    <div className="overflow-x-auto rounded-xl border border-gray-200">
                      <table className="w-full text-sm border-collapse">
                        <thead className="bg-emerald-50">
                          <tr>
                            <th className="border-b border-gray-200 px-4 py-3 text-left font-bold text-emerald-800">Category</th>
                            <th className="border-b border-gray-200 px-4 py-3 text-right font-bold text-emerald-800">Amount (PKR)</th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr className="bg-emerald-50 font-bold">
                            <td className="px-4 py-3 text-emerald-800">Total Income</td>
                            <td className="px-4 py-3 text-right text-emerald-800">{formatPKR(reportData.totalIncome)}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
