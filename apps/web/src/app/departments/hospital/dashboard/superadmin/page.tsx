// src/app/departments/hospital/dashboard/superadmin/page.tsx
'use client';
      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-8 text-center animate-in fade-in zoom-in duration-500">
        ...
        <div className="space-y-4">
          <Link 
            ...
            className="flex items-center justify-center gap-2 w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl font-bold transition-all shadow-lg shadow-emerald-100 group"
          >
            Go to HQ Dashboard
          ...
          <p className="text-[10px] text-gray-400 font-medium uppercase tracking-widest">
            You will no longer be able to manage HQ tasks from the Hospital portal.
          </p>
        </div>
      </div>
    </div>
