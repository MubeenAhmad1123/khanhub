...
export default function ItLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6">
      <div className="w-full max-w-lg bg-white p-12 rounded-[50px] shadow-2xl shadow-indigo-100/50 border border-indigo-50 flex flex-col gap-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center">
          <h1 className="text-5xl font-black text-gray-900 tracking-tight mb-3 font-display">IT Department</h1>
          <p className="text-indigo-600 font-black uppercase text-xs tracking-[0.4em] ml-1">Access Authentication</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <input 
              type="text" 
              placeholder="e.g. IT-ADM-001"
              required
              className="bg-gray-50 border-none rounded-[30px] px-8 py-6 text-gray-700 font-bold focus:ring-4 focus:ring-indigo-600/10 outline-none transition-all placeholder:text-gray-300"
              value={customId}
          ...
          <button 
            type="submit"
            disabled={loading}
            className="mt-4 bg-gray-900 text-white rounded-[30px] py-6 font-black text-lg shadow-2xl shadow-indigo-900/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
          >
