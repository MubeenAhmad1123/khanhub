...
import { 
  ...
  AlertCircle, ChevronRight, Download, Info, Terminal, Sparkles
} from 'lucide-react';
    ...
    const loadProfile = async () => {
      try {
        ...
        if (!userSnap.exists()) {
           ...
           setProfile({ id: hqSnap.id, ...hqData });
           fetchMetrics(hqSnap.id);
        } else {
           const itData = userSnap.data();
           setProfile({ id: userSnap.id, ...itData });
