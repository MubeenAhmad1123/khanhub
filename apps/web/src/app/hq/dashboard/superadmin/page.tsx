      ...
      <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-sm">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <Link className="flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm font-bold text-white hover:bg-white/10 transition-colors" href="/hq/dashboard/superadmin/users">
              Manage users
            </Link>
            <Link className="flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm font-bold text-white hover:bg-white/10 transition-colors" href="/hq/dashboard/superadmin/settings">
              Settings
            </Link>
            <Link className="flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm font-bold text-white hover:bg-white/10 transition-colors" href="/hq/dashboard/superadmin/departments">
              Departments hub
            </Link>
            <Link className="flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm font-bold text-white hover:bg-white/10 transition-colors" href="/hq/dashboard/superadmin/audit">
              Audit logs
            </Link>
          </div>
        </div>
          ...
          {!activity.length ? (
            ...
            <div className="mt-3 space-y-2">
              {activity.slice(0, 8).map((a) => (
                <div key={a.id} className="rounded-xl border border-white/10 bg-white/5 px-3 py-3">
                  <div className="flex items-center justify-between gap-2">
                    <p className="text-sm font-bold text-white line-clamp-1">{a.msg}</p>
                    <span className="shrink-0 text-xs font-semibold text-gray-400">{a.when}</span>
                  </div>
                  <p className="mt-1 text-xs font-medium text-gray-400">by {a.who}</p>
                </div>
              ))}
            </div>
          )}
