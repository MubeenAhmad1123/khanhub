        ...
        <div className="bg-white dark:bg-black border border-gray-100 dark:border-white/10 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
            ...
            <div className="rounded-3xl border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-6 shadow-sm transition-all hover:border-black dark:hover:border-white sm:col-span-2">
              ...
              <div className="text-[10px] font-black font-mono text-black dark:text-black break-all">{patientId}</div>
            </div>
          </div>
                ...
                <div className="space-y-6 text-sm">
                  ...
                  {patient.isActive === false && (
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col min-w-0">
                        <span className="text-[9px] font-black text-black uppercase tracking-widest mb-0.5">Termination Sequence (Discharge)</span>
                  ...
                  <div className="pt-6 border-t border-gray-100 dark:border-white/5 grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col text-right">
                      <span className="text-[9px] font-black text-black uppercase tracking-widest mb-0.5">Node Class</span>
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black uppercase tracking-widest text-black dark:text-black">Responsible Node</span>
