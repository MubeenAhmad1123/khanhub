...
export default function SuperadminGrowthIdeasPage() {
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
          <div>
            <div className="flex items-center gap-2 text-indigo-600 mb-1">
              ...
              <span className="text-xs font-black uppercase tracking-wider">Superadmin Panel</span>
            </div>
            <h1 className="text-2xl lg:text-3xl font-black text-gray-900 tracking-tight">System Staff suggestions</h1>
            <p className="text-gray-500 text-sm font-semibold">Monitor and review all growth ideas submitted by staff members across the system</p>
          </div>
          <button 
            onClick={fetchData} 
                          ...
                          <div className="flex flex-row md:flex-col justify-end items-end gap-2 md:w-48 self-end md:self-center">
                            ...
                            {isApproved && (
                              <div className="text-[10px] font-bold text-gray-400 italic text-right w-full">
                                Approved by {idea.approvedBy || 'Superadmin'}
                              </div>
                            )}
                          </div>
                        </div>
