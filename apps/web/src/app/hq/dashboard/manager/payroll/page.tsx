...
export default function ManagerPayrollPage() {
  ...
  const handleLoad = async () => {
    try {
      ...
      // Fetch advances globally across all department transaction & advance collections
      ...
      const results = await Promise.all(ALL_DEPTS.map(async (dept) => {
        ...
        try {
          ...
          const salaryRows = allStaff.map((staff: any) => {
            ...
            // Advance calculation for this staff member (using global advance transactions)
