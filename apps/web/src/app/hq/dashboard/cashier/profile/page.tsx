    ...
    <div className="min-h-screen bg-[#FCFBF8] p-4 md:p-8 pb-32 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      <div className="max-w-xl mx-auto space-y-12">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div>
                ...
                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mt-1">Manage your account details</p>
            </div>
          </div>
        </header>
        ...
        <div className="relative group">
            ...
            <div className="relative flex flex-col items-center gap-6 py-12 bg-white rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] border border-zinc-100 shadow-2xl shadow-zinc-200/50 overflow-hidden">
        ...
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-10 border border-zinc-100 shadow-2xl shadow-zinc-200/30 space-y-10">
          <div className="grid grid-cols-1 gap-8">
            <div className="space-y-4">
              <label className="text-zinc-900 text-[11px] font-black uppercase tracking-[0.2em] block px-1">Name</label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 border border-zinc-100 rounded-[1.5rem] sm:rounded-[2rem] pl-14 pr-6 py-4 sm:py-5 text-zinc-900 text-sm font-bold outline-none focus:bg-white focus:border-indigo-500 focus:shadow-xl focus:shadow-indigo-100/50 transition-all"
                />
              </div>
            </div>
            
            <div className="space-y-4">
              <label className="text-zinc-900 text-[11px] font-black uppercase tracking-[0.2em] block px-1">Phone</label>
              <div className="relative group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="p-4 sm:p-6 bg-zinc-50/50 border border-zinc-100 rounded-[1.5rem] sm:rounded-[2rem] space-y-2">
                <label className="text-zinc-400 text-[9px] font-black uppercase tracking-widest block">User ID</label>
                <p className="text-sm font-black text-zinc-900 uppercase">{session?.customId || 'N/A'}</p>
              </div>
              <div className="p-4 sm:p-6 bg-zinc-50/50 border border-zinc-100 rounded-[1.5rem] sm:rounded-[2rem] space-y-2">
                <label className="text-zinc-400 text-[9px] font-black uppercase tracking-widest block">Email Address</label>
          ...
          <button
            ...
            className={cn(
              "w-full font-black text-xs uppercase tracking-[0.2em] py-5 sm:py-6 rounded-[1.5rem] sm:rounded-[2rem] transition-all duration-500 active:scale-95 flex items-center justify-center gap-4 shadow-2xl",
              saved 
                ? "bg-emerald-500 text-white shadow-emerald-200" 
                : "bg-indigo-600 hover:bg-zinc-900 text-white shadow-indigo-200 disabled:opacity-50"
            )}
          >
            {saving ? <Loader2 className="animate-spin" size={20} /> : saved ? 'Profile Updated' : <><Save size={20} /> Save Changes</>}
          </button>
        </div>

        <button
          onClick={handleLogout}
          className="w-full bg-white hover:bg-rose-500 hover:text-white border border-zinc-100 text-zinc-400 font-black text-xs uppercase tracking-[0.3em] py-5 sm:py-6 rounded-[1.5rem] sm:rounded-[2rem] transition-all duration-500 flex items-center justify-center gap-4 shadow-sm hover:shadow-2xl hover:shadow-rose-100 active:scale-95 group"
        >
