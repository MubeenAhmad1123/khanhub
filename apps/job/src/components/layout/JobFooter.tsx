...
export default function JobFooter() {
    ...
    return (
        <footer className="bg-jobs-primary text-white/80 mt-16">
                    ...
                    <div>
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/60 font-medium">Find Your Career</p>
                            </div>
                        </div>
                        ...
                        <div className="flex space-x-3">
                            ...
                            <a href="https://wa.me/923006395220" target="_blank" className="text-white/40 hover:text-white transition-colors">
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Bottom Bar */}
            <div className="bg-jobs-dark py-6 border-t border-white/5">
