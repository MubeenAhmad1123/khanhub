...
export default function JobPostForm({ onSuccess, isAdmin = false }: JobPostFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // ⭐ FIX: Define status based on whether user is admin
            const jobStatus = isAdmin ? 'active' : 'pending';
            ...
            const jobData = {
                ...
                employerId: user.uid,
                status: jobStatus, // ⭐ FIX: Now properly defined
                isFeatured: isAdmin,
                isPremium: false,
            ...
            console.log('Attempting to save job with status:', jobData.status);
